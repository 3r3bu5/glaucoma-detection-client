        ...
        <div className="flex flex-wrap">
          ...
          <img className="lg:max-w-2xl absolute left-28 top-48 mx-auto" src={robodoc} alt="" />
            <div className="absolute bottom-20 inset-x-0 mx-auto mb-12 max-w-xl text-center" style={{"z-index": "10"}}>
              <h2 className="mb-2 text-2xl text-white font-black">Join Glaucoma lab today!</h2>
              <div className="max-w-lg mx-auto">
                <p className="mb-6 text-gray-50 leading-loose">Register a new account and get 2 scans for free</p>
              </div>
            </div>
          </div>
